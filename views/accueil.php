    ...
    <header class="accueil-header">
        <div class="accueil-header-content">
            ...
            <nav class="accueil-nav">
                <a href="/index.php?controller=auth&action=login" class="btn-login">Connexion</a>
                <a href="/index.php?controller=auth&action=register" class="btn-register">Inscription</a>
            </nav>
    ...
    <main class="accueil-main">
        <div class="accueil-hero">
            ...
            <div class="accueil-cta">
                <a href="/index.php?controller=auth&action=register" class="btn-cta-primary">Commencer maintenant</a>
                <a href="/index.php?controller=auth&action=login" class="btn-cta-secondary">J'ai déjà un compte</a>
            </div>
        </div>
